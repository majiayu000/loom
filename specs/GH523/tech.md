...
| B-010 | compatibility policy diff fixture | `cargo test contract_range_requires_migration_note_with_explicit_base && cargo test contract_range_missing_diff_base_fails` |
