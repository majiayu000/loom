...
- [ ] `SP537-T003` Owner: errors | Dependencies: `SP537-T002` | Done when: universal remote/lock defaults, contextual conflict/policy call-site actions, and written pure-fault exemptions form a total table covering all 30 codes including `INIT_ERROR`; no default action requires missing arguments | Verify: `cargo test error_actions`
