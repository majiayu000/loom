...
- [ ] `SP534-T002` Owner: tooling | Dependencies: `SP534-T001` | Done when: `scripts/module-ceiling.sh` + allowlist exist and pass on current tree | Verify: `bash scripts/module-ceiling.sh`
