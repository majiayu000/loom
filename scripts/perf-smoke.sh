...
# Hard ceiling: 5440 KiB. The durable plan/apply protocol, offline eval
...
# command surfaces with prompt redaction and source digest metadata.
max_bin_bytes=$((5440 * 1024))
