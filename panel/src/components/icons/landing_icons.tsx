...
export const ArrowRightIcon = (p: IconProps) => (
  <svg aria-hidden="true" focusable="false" width="14" height="14" viewBox="0 0 24 24" strokeWidth="2" {...base} {...p}>
    <path d="M5 12h14M13 6l6 6-6 6" />
  </svg>
);

export const PanelIcon = (p: IconProps) => (
  <svg aria-hidden="true" focusable="false" width="14" height="14" viewBox="0 0 24 24" strokeWidth="1.6" {...base} {...p}>
...
export const CopyIcon = (p: IconProps) => (
  <svg aria-hidden="true" focusable="false" width="13" height="13" viewBox="0 0 24 24" strokeWidth="1.6" {...base} {...p}>
...
export const StarIcon = (p: IconProps) => (
  <svg aria-hidden="true" focusable="false" width="12" height="12" viewBox="0 0 24 24" strokeWidth="1.8" {...base} {...p}>
...
export const LinkIcon = (p: IconProps) => (
  <svg aria-hidden="true" focusable="false" width="20" height="20" viewBox="0 0 24 24" strokeWidth="1.6" {...base} {...p}>
...
export const GitHubIcon = (p: IconProps) => (
  <svg aria-hidden="true" focusable="false" width="14" height="14" viewBox="0 0 24 24" fill="currentColor" {...p}>
