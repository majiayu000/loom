...
mod tests {
    ...
    fn agent_capabilities_track_error_codes_and_next_action_fields() {
        ...
        for field in [
            ...
            "field:envelope.data.convergence.projections.evidence.checkpoint_updated_at:optional-string",
            "field:envelope.data.convergence.projections.observed_at:optional-string",
            "field:envelope.data.convergence.visibility.agent:optional-string",
            "field:envelope.data.convergence.visibility.evidence.observed_revision:optional-string",
            "field:envelope.data.convergence.visibility.evidence.checkpoint_updated_at:optional-string",
