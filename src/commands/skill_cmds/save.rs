...
use super::super::helpers::{
    map_arg, map_git, map_lock, map_registry_state, maybe_autosync_or_queue,
    record_registry_operation, snapshot_registry_audit_state,
    validate_skill_name,
};
use super::super::{App, CommandFailure};
use super::shared::{rollback_registry_audit_after_failure, stage_registry_state};
    ...
    pub fn cmd_save(
        ...
        if !skill_path.exists() {
            return Err(CommandFailure::new(
                crate::types::ErrorCode::SkillNotFound,
        ...
        if let Err(err) = super::shared::maybe_skill_fault("skill_save_after_operation") {
