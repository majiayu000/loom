...
# Hard ceiling: 5716 KiB. The durable plan/apply protocol, offline eval
...
# read-only eval report discovery plus policy/safety summary plumbing while
# keeping cold CLI startup guarded below.
max_bin_bytes=$((5716 * 1024))
