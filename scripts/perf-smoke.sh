...
# Hard ceiling: 5680 KiB. The durable plan/apply protocol, offline eval
...
# events, status summaries, and diagnose write-back plumbing while keeping cold
# CLI startup guarded below. Skill inspect evidence surfacing adds read-only eval
# report discovery plus policy/safety summary plumbing.
max_bin_bytes=$((5680 * 1024))
