...
- [ ] `SP534-T002` Owner: tooling | Dependencies: `SP534-T001` | Done when: `scripts/module-ceiling.sh` + 3-entry allowlist (`#544`, `#545`, `#546`) exist and pass on current tree; format is `path<TAB>baseline_lines<TAB>issue-ref` | Verify: `bash scripts/module-ceiling.sh`
