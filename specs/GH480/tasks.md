...
- [ ] `SP480-T002` Owner: eval evidence | Dependencies: `SP480-T001` | Done when: inspect reads latest eval evidence and reports status, timestamp, precision, recall, stale evidence, and malformed evidence errors | Verify: `cargo test skill_eval && cargo test skill_inspect`
