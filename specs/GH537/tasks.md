...
- [x] `SP537-T005` Owner: verification | Dependencies: all prior | Done when: full checks pass | Verify: implementation head `b357b73` passed `cargo check --workspace --all-targets --all-features`, `cargo test`, full `make check`, independent review with no findings, and GitHub CI run `29503275488` on 2026-07-16
