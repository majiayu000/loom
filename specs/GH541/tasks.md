...
- [ ] `SP541-T001` Owner: spec/review | Dependencies: none | Done when: fixture-owned invocation anchors、unmatched/rejected persistence、export、home precedence、canonical source identity、cursor privacy/backfill、missing-root behavior 与 retired-skill policy 均记录且独立 diff review 无 blocker | Verify: independent PR #543 reviewer confirms all validated review findings are mapped | Covers: B-001, B-002, B-004, B-005, B-006, B-007, B-009, B-010
