...
const HISTORY_SEGMENTS_DIR: &str = "registry_ops_history";
const HISTORY_ARCHIVES_DIR: &str = "registry_ops_archive";
const HISTORY_SNAPSHOT_FILE: &str = "registry_ops_snapshot.json";
