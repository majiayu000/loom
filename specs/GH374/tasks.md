...
- [ ] `SP374-T003` Owner: docs-codex | Done when: `docs/CODEX_SKILL_VISIBILITY.md` explains `~/.agents/skills`, legacy `${CODEX_HOME:-~/.codex}/skills`, repo `.agents/skills`, symlink canonicalization, config disables, and restart guidance | Verify: `rg -n "\\.agents/skills|CODEX_HOME|skills.config|restart|--json" docs/CODEX_SKILL_VISIBILITY.md`
