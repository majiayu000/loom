...
- [ ] `SP524-T001` Owner: CLI/planner | Dependencies: approved GH524 specs, approved #522 contract | Done when: `skill converge` command/ADR 例外与 typed plan 落地，selectors、required axes、plan digest 稳定，dry-run 只读，且 apply 强制携带并验证该 digest | Verify: `cargo test --test skill_convergence exact_effect_plan dry_run_is_read_only apply_requires_reviewed_plan_digest` | Covers: B-001, B-004, B-006, B-010, B-015
