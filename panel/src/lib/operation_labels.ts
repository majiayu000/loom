...
const INTENT_LABELS: Record<string, IntentDescriptor> = {
  "workspace.init": { category: "Workspace", phrase: "workspace initialization" },
  "workspace.remote.set": { category: "Workspace", phrase: "remote configuration" },
  ...
  "plan.converge": { category: "Convergence", phrase: "convergence planning" },
  "apply": { category: "Convergence", phrase: "reviewed plan apply" },
  "skill.add": { category: "Skill", phrase: "skill import" },
  "skill.project": { category: "Projection", phrase: "skill projection" },
  "skill.commit": { category: "Commit", phrase: "skill commit" },
  "skill.rollback": { category: "Rollback", phrase: "skill rollback" },
  "skill.trash.add": { category: "Trash", phrase: "skill trash" },
  "skill.trash.restore": { category: "Trash", phrase: "skill restore" },
  "skill.trash.purge": { category: "Trash", phrase: "trash purge" },
  ...
  "ops.retry": { category: "Operations", phrase: "operation retry" },
  "ops.purge": { category: "Operations", phrase: "operation purge" },
  "ops.history.repair": { category: "Operations", phrase: "history repair" },
...
const ACTION_LABELS: Record<string, string> = {
  ...
  "use": "使用技能流程",
  "plan.converge": "规划技能收敛",
  "apply": "执行已审阅计划",
  "skill.add": "导入技能",
  "skill.project": "投影到目标目录",
  "skill.commit": "提交技能变更",
  "skill.trash.add": "将技能移入回收站",
  "skill.trash.restore": "从回收站恢复技能",
  "skill.trash.purge": "永久清理回收站条目",
...
export function bucketRegistryOperation(op: RegistryOperationRecord): OperationStatus {
  ...
  if (s === "ok" || s === "applied" || s === "completed" || s === "done" || s === "succeeded") {
