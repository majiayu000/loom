...
use crate::cli::{
    ...
    ProjectionMethod, SkillCommand, SkillOrphanCommand, SkillTrashCommand, SkillsetCommand,
    SyncCommand, TargetCommand, WorkspaceBindingCommand, WorkspaceCommand, WorkspaceMatcherKind,
};
