...
| `loom provision plan/doctor/apply/export/import` | Plan devcontainer and remote active-view provisioning without mutation | Preview generated devcontainer setup, active-view paths, dependency readiness, secret names, and policy gates before any apply/export/import exists | Registry + target workspace (read-only for plan/doctor) |
