...
- [x] `SP534-T005` Owner: verification | Dependencies: all prior | Done when: full checks pass | Verify: `cargo check --workspace --all-targets --all-features && make check`; CI verification passed on PR #547 implementation head `f7abfba`
